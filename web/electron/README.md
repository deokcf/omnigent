...
choice. Only the visible, active pane can prompt. HTTPS sites and HTTP loopback
pages can request access; subframes cannot independently request it.
...
the shell's own sign-in window policy. Camera, microphone, notifications, and other browser
